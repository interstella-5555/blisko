      ...
      <div className={s.mapArea}>
        <div className={s.isobars}>
          <svg viewBox="0 0 360 300" fill="none" xmlns="http://www.w3.org/2000/svg">
            <title>Isobar pressure lines</title>
            <path
              d="M-20 250 Q80 200 160 220 Q240 240 320 190 Q380 150 400 170"
              stroke="rgba(0,188,212,0.15)"
              strokeWidth="1"
              fill="none"
            />
            <path
              d="M-20 210 Q90 160 170 185 Q250 210 330 155 Q400 110 420 130"
              stroke="rgba(0,188,212,0.12)"
              strokeWidth="1"
              fill="none"
            />
            <path
              d="M-20 170 Q100 120 180 150 Q260 180 340 120 Q400 70 420 90"
              stroke="rgba(0,188,212,0.1)"
              strokeWidth="1"
              fill="none"
            />
            <path
              d="M-20 130 Q110 80 190 115 Q270 150 350 85 Q400 30 420 50"
              stroke="rgba(0,188,212,0.08)"
              strokeWidth="1"
              fill="none"
            />
            <path
              d="M-20 90 Q120 40 200 80 Q280 120 360 50"
