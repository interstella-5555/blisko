      ...
      <div className={s.mapArea}>
        ...
        <div className={s.contourLines}>
          <svg viewBox="0 0 390 400" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M-20 320 Q80 280 160 300 Q240 320 320 270 Q400 220 430 240"
              stroke="#C9BFA8"
              strokeWidth="1"
              fill="none"
              opacity="0.5"
            />
            <path
              d="M-20 290 Q90 240 170 265 Q250 290 330 235 Q410 180 430 200"
              stroke="#C9BFA8"
              strokeWidth="1"
              fill="none"
              opacity="0.4"
            />
            <path
              d="M-20 255 Q100 200 180 230 Q260 260 340 200 Q420 140 430 160"
              stroke="#C9BFA8"
              strokeWidth="1"
              fill="none"
              opacity="0.35"
            />
            <path
              d="M-20 220 Q110 160 190 195 Q270 230 350 165 Q430 100 430 120"
              stroke="#C9BFA8"
              strokeWidth="1"
              fill="none"
              opacity="0.3"
            />
            <path
              d="M-20 185 Q120 120 200 160 Q280 200 360 130 Q430 60 430 80"
              stroke="#C9BFA8"
              strokeWidth="1"
              fill="none"
              opacity="0.25"
            />
            <path
              d="M-20 150 Q130 80 210 125 Q290 170 370 95 Q430 20 430 40"
              stroke="#C9BFA8"
              strokeWidth="1"
              fill="none"
              opacity="0.2"
            />
            <path
              d="M-20 115 Q140 40 220 90 Q300 140 380 60 Q430 -20 430 0"
              stroke="#C9BFA8"
              strokeWidth="1"
              fill="none"
              opacity="0.15"
