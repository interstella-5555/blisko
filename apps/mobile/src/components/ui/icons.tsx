...
export function IconFilter({ size = defaultSize, color = defaultColor }: IconProps) {
  return (
    <Svg
      width={size}
      height={size}
...
export function IconBulletRose({ size = 12, color = defaultColor }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 12 12">
      <Path
        d="M6 1.5C6 1.5 7.5 3.5 7.5 4.5C7.5 5.5 6.8 6 6 6C5.2 6 4.5 5.5 4.5 4.5C4.5 3.5 6 1.5 6 1.5Z"
        fill={color}
      />
      <Path
        d="M6 10.5C6 10.5 7.5 8.5 7.5 7.5C7.5 6.5 6.8 6 6 6C5.2 6 4.5 6.5 4.5 7.5C4.5 8.5 6 10.5 6 10.5Z"
        fill={color}
      />
      <Path
        d="M1.5 6C1.5 6 3.5 4.5 4.5 4.5C5.5 4.5 6 5.2 6 6C6 6.8 5.5 7.5 4.5 7.5C3.5 7.5 1.5 6 1.5 6Z"
        fill={color}
      />
      <Path
        d="M10.5 6C10.5 6 8.5 4.5 7.5 4.5C6.5 4.5 6 5.2 6 6C6 6.8 6.5 7.5 7.5 7.5C8.5 7.5 10.5 6 10.5 6Z"
        fill={color}
      />
    </Svg>
  );
...
export function IconPlus({ size = defaultSize, color = defaultColor }: IconProps) {
  return (
    <Svg
      width={size}
      height={size}
...
export function IconBell({ size = defaultSize, color = defaultColor }: IconProps) {
  return (
    <Svg
      width={size}
      height={size}
...
export function IconBellOff({ size = defaultSize, color = defaultColor }: IconProps) {
  return (
    <Svg
      width={size}
      height={size}
...
export function IconGroup({ size = defaultSize, color = defaultColor }: IconProps) {
  return (
    <Svg
      width={size}
      height={size}
