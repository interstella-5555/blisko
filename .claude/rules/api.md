...
- `style/run-check` — Before finishing any task, run `npx @biomejs/biome check .` and verify 0 errors. Biome formatting runs automatically on commit via husky + lint-staged pre-commit hook.
